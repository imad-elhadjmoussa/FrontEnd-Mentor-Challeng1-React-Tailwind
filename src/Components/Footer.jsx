...
import instgramIcon from './../huddle-landing-page-with-alternating-feature-blocks-master/images/instgram-icon.png'
import twiterIcon from './../huddle-landing-page-with-alternating-feature-blocks-master/images/twitter-con.png'
...
export const Footer = () => {
    ...
    return (
        <div className='flex flex-col items-center md:flex-row md:justify-between md:px-20   pt-36 pb-10 w-full  bg-dark-green'>
            <div>
                {
                    information.map((ele) => {
                        return (
                    ...
                    icons.map((ele) => {
                        return (
                            <div key={ele} className='cursor-pointer py-3 px-5 text-white' >
                                <img className='w-14 h-14 ' src={ele} />
                            </div>
                        )
                    }
